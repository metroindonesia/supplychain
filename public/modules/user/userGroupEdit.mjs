...
async function btn_del_click(self, evt) {
	...
	try {
		...
		// Extender Deleting
		// export async function userGroupEdit_dataDeleting(self, id, args) {}
		const args = { cancelDelete: false }
		const fn_datadeleting_name = 'userGroupEdit_dataDeleting'
		...
		// Extender Delete
		// export async function userGroupEdit_dataDeleted(self, data) {}
		const fn_datadeleted_name = 'userGroupEdit_dataDeleted'
