...
async function btn_del_click(self, evt) {
	...
	try {
		...
		// Extender Deleting
		// export async function userFavouriteEdit_dataDeleting(self, id, args) {}
		const args = { cancelDelete: false }
		const fn_datadeleting_name = 'userFavouriteEdit_dataDeleting'
		...
		// Extender Delete
		// export async function userFavouriteEdit_dataDeleted(self, data) {}
		const fn_datadeleted_name = 'userFavouriteEdit_dataDeleted'
