...
export async function init(self, args) {
	...
	// export function userLoginList_addTableEvents(self, tbl) {}
	const fn_addTableEvents_name = 'userLoginList_addTableEvents'
...
async function listRows(self, criteria, offset, limit, sort) {
	...
	// export async function userLoginList_dataLoad(self, criteria, sort, evt) {}
	const fn_dataLoad_name = 'userLoginList_dataLoad'
...
async function deleteRows(self, data) {
	...
	try {
		...
		if (result.deleted) {
			...
			// export async function userLoginList_rowsDeleted(self, data) {}
			const fn_name = 'userLoginList_rowsDeleted'
...
async function tbl_loadData(self, params={}) {
	...
	try {
		...
		// export async function userLoginList_tableDataLoaded(self, tbl, result) {}
		const fn_name = 'userLoginList_tableDataLoaded'
		const fn = Extender[fn_name]
		if (typeof fn === 'function') {
