...
import * as brandHeaderList from './brandHeaderList.mjs' 
import * as brandHeaderEdit from './brandHeaderEdit.mjs' 
import * as Extender from './brand-ext.mjs'
...
export default class extends Module {
	...
	async main(args={}) {
		...
		try {
			...
			await Promise.all([ 
				brandHeaderList.init(self, args), 
				brandHeaderEdit.init(self, args), 
			...
			const modNameList = ['brandHeaderEdit']
...
async function render(self) {
	try {
		...
		// Setup Icon
		Crsl.setIconUrl('public/modules/brand/brand.svg')
		...
		// brand-ext.mjs, export function extendPage(self) {} 
