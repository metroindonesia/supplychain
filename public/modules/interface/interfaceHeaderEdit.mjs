...
import * as Ext from './interface-ext.mjs'
...
export async function init(self, args) {
	...
	// export async function interfaceHeaderEdit_init(self, CurrentState)
	const fn_init_name = 'interfaceHeaderEdit_init'
...
export async function openSelectedData(self, params) {
	...
	try {
		...
		// export async function interfaceHeaderEdit_isEditDisabled(self, data)
...
async function  frm_locked(self, evt) {
	...
	// export function interfaceHeaderEdit_formLocked(self, frm, CurrentState) {}
...
async function  frm_unlocked(self, evt) {
	...
	// export function interfaceHeaderEdit_formUnlocked(self, frm, CurrentState) {}
...
async function btn_new_click(self, evt) {
	...
	try {
		...
		if (typeof fn_newdata === 'function') {
			// export async function interfaceHeaderEdit_newData(self, datainit, frm) {}
...
async function btn_save_click(self, evt) {
	...
	// Extender Saving
	// export async function interfaceHeaderEdit_dataSaving(self, dataToSave, frm, args) {}
	...
	try {
		...
		if (typeof fn_datasaved === 'function') {
			// export async function interfaceHeaderEdit_dataSaved(self, data, frm) {}
