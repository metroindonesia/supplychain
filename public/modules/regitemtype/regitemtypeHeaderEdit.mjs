...
import * as Ext from './regitemtype-ext.mjs'
...
const CurrentSectionId = Context.Sections.regitemtypeHeaderEdit
const CurrentSection = Crsl.Items[CurrentSectionId]
const Source = Context.Source
const CurrentState = {}

const TitleWhenNew = 'New Register Item Type'
const TitleWhenView = 'View Register Item Type'
const TitleWhenEdit = 'Edit Register Item Type'
const EditModeText = 'Edit'
const LockModeText = 'Lock'

const btn_edit = new $fgta5.ActionButton('regitemtypeHeaderEdit-btn_edit')
const btn_save = new $fgta5.ActionButton('regitemtypeHeaderEdit-btn_save')
const btn_new = new $fgta5.ActionButton('regitemtypeHeaderEdit-btn_new', 'regitemtypeHeader-new')
const btn_del = new $fgta5.ActionButton('regitemtypeHeaderEdit-btn_delete')
const btn_reset = new $fgta5.ActionButton('regitemtypeHeaderEdit-btn_reset')
const btn_prev = new $fgta5.ActionButton('regitemtypeHeaderEdit-btn_prev')
const btn_next = new $fgta5.ActionButton('regitemtypeHeaderEdit-btn_next')


const btn_recordstatus = document.getElementById('regitemtypeHeader-btn_recordstatus')
const btn_logs = document.getElementById('regitemtypeHeader-btn_logs')
const btn_about = document.getElementById('regitemtypeHeader-btn_about')

const frm = new $fgta5.Form('regitemtypeHeaderEdit-frm');
const obj_regitemtype_id = frm.Inputs['regitemtypeHeaderEdit-obj_regitemtype_id']
const obj_regitemtype_isdisabled = frm.Inputs['regitemtypeHeaderEdit-obj_regitemtype_isdisabled']
const obj_regitemtype_name = frm.Inputs['regitemtypeHeaderEdit-obj_regitemtype_name']
const obj_regitemtype_descr = frm.Inputs['regitemtypeHeaderEdit-obj_regitemtype_descr']	
...
export async function init(self, args) {
	console.log('initializing regitemtypeHeaderEdit ...')
	...
	// export async function regitemtypeHeaderEdit_init(self, CurrentState)
	const fn_init_name = 'regitemtypeHeaderEdit_init'
...
export async function openSelectedData(self, params) {
	...
	try {
		...
		// export async function regitemtypeHeaderEdit_isEditDisabled(self, data)
		const fn_iseditdisabled_name = 'regitemtypeHeaderEdit_isEditDisabled'
		...
		// export async function regitemtypeHeaderEdit_formOpened(self, frm, CurrentState)
		const fn_formopened_name = 'regitemtypeHeaderEdit_formOpened'
...
async function backToList(self, evt) {
	...
	if (goback) {
		frm.lock()
		const listId =  Context.Sections.regitemtypeHeaderList
...
async function  frm_locked(self, evt) {
	...
	// export function regitemtypeHeaderEdit_formLocked(self, frm, CurrentState) {}
	const fn_name = 'regitemtypeHeaderEdit_formLocked'
...
async function  frm_unlocked(self, evt) {
	...
	// export function regitemtypeHeaderEdit_formUnlocked(self, frm, CurrentState) {}
	const fn_name = 'regitemtypeHeaderEdit_formUnlocked'
	const fn = Extender[fn_name]
	if (typeof fn === 'function') {
		fn(self, frm, CurrentState)
	}
...
async function btn_new_click(self, evt) {
	...
	const regitemtypeHeaderList = self.Modules.regitemtypeHeaderList
	const listsecid = regitemtypeHeaderList.Section.Id
	...
	try {
		...
		const fn_newdata_name = 'regitemtypeHeaderEdit_newData'
		const fn_newdata = Extender[fn_newdata_name]
		if (typeof fn_newdata === 'function') {
			// export async function regitemtypeHeaderEdit_newData(self, datainit, frm) {}
		...
		if (fromListSection) {
			...
			self.Modules.regitemtypeHeaderList.Section.show()
		}
	}
}
...
async function btn_save_click(self, evt) {
	...
	// Extender Autofill
	const fn_autofill_name = 'regitemtypeHeaderEdit_autofill'
	...
	// Extender Saving
	// export async function regitemtypeHeaderEdit_dataSaving(self, dataToSave, frm, args) {}
	const args = { cancelSave: false }
	const fn_datasaving_name = 'regitemtypeHeaderEdit_dataSaving'
	...
	try {
		...
		// Extender Saving
		const fn_datasaved_name = 'regitemtypeHeaderEdit_dataSaved'
		const fn_datasaved = Extender[fn_datasaved_name]
		if (typeof fn_datasaved === 'function') {
			// export async function regitemtypeHeaderEdit_dataSaved(self, data, frm) {}
		...
		if (isNewData) {
			...
			self.Modules.regitemtypeHeaderList.addNewRow(self, data)
		} else {
			console.log('update data baris yang dibuka')
			self.Modules.regitemtypeHeaderList.updateCurrentRow(self, data)
		}
...
async function btn_del_click(self, evt) {
	...
	try {
		...
		self.Modules.regitemtypeHeaderList.removeCurrentRow(self)
...
async function btn_prev_click(self, evt) {
	...
	self.Modules.regitemtypeHeaderList.selectPreviousRow(self)
}

async function btn_next_click(self, evt) {
	console.log('btn_next_click')
	self.Modules.regitemtypeHeaderList.selectNextRow(self)
}
...
async function btn_recordstatus_click(self, evt) {
	...
	pageHelper.openSection(self, 'fRecord-section', params, async ()=>{
		...
		try {
			...
			const fn_addrecordinfo_name = 'regitemtypeHeaderEdit_addRecordInfo'
...
async function btn_about_click(self, evt) {
	...
	pageHelper.openSection(self, 'fAbout-section', params, async ()=>{
		...
		AboutSection.Title = 'About Register Item Type'
