...
const CurrentSectionId = Context.Sections.regitemtypeHeaderList
const CurrentSection = Crsl.Items[CurrentSectionId]
const CurrentState = {}

const tbl =  new $fgta5.Gridview('regitemtypeHeaderList-tbl')
const pnl_search = document.getElementById('regitemtypeHeaderList-pnl_search')
const btn_gridload = new $fgta5.ActionButton('regitemtypeHeaderList-btn_gridload') 

export const Section = CurrentSection
export const SearchParams = {}

export async function init(self, args) {
	console.log('initializing regitemtypeHeaderList ...')
	...
	try {
		...
		const obj_searchtext = document.getElementById('regitemtypeHeaderList-txt_searchtext')
		const btn_load = document.getElementById('regitemtypeHeaderList-btn_gridload')
		...
		// regitemtypeHeaderList-ext.mjs, export function initSearchParams(self, SearchParams) {} 
...
export function keyboardAction(self, actionName, evt) {
	if (actionName=='up') {
		...
		const regitemtypeHeaderEdit = self.Modules.regitemtypeHeaderEdit
		if (tbl.CurrentRow!=null) {
			regitemtypeHeaderEdit.Section.show({}, ()=>{
...
async function openRow(self, tr) {
	...
	const regitemtypeHeaderEdit = self.Modules.regitemtypeHeaderEdit
	regitemtypeHeaderEdit.clearForm(self, 'loading...')

	try {
		setCurrentRow(self, tr)
		CurrentState.SelectedRow.keyValue = keyvalue
		CurrentState.SelectedRow.key = key
		await regitemtypeHeaderEdit.openSelectedData(self, {key:key, keyvalue:keyvalue})

		// matikan atau nyalakan button prev/next sesuai kondisi
		setPagingButton(self, regitemtypeHeaderEdit)
...
function tbl_cellclick(self, evt) {
	...
	const regitemtypeHeaderEdit = self.Modules.regitemtypeHeaderEdit
	regitemtypeHeaderEdit.Section.show({}, (evt)=>{
		openRow(self, tr)
	})
...
async function tbl_loadData(self, params={}) {
	console.log('loading regitemtypeHeader data')
	console.log(params)
