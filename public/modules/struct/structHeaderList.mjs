...
const CurrentSectionId = Context.Sections.structHeaderList
const CurrentSection = Crsl.Items[CurrentSectionId]
const CurrentState = {}

const tbl =  new $fgta5.Gridview('structHeaderList-tbl')
const pnl_search = document.getElementById('structHeaderList-pnl_search')
const btn_gridload = new $fgta5.ActionButton('structHeaderList-btn_gridload') 

export const Section = CurrentSection
export const SearchParams = {}

export async function init(self, args) {
	console.log('initializing structHeaderList ...')
	...
	try {
		...
		const obj_searchtext = document.getElementById('structHeaderList-txt_searchtext')
		const btn_load = document.getElementById('structHeaderList-btn_gridload')
		...
		// structHeaderList-ext.mjs, export function initSearchParams(self, SearchParams) {} 
...
async function openRow(self, tr) {
	...
	const structHeaderEdit = self.Modules.structHeaderEdit
	structHeaderEdit.clearForm(self, 'loading...')

	try {
		setCurrentRow(self, tr)
		CurrentState.SelectedRow.keyValue = keyvalue
		CurrentState.SelectedRow.key = key
		await structHeaderEdit.openSelectedData(self, {key:key, keyvalue:keyvalue})

		// matikan atau nyalakan button prev/next sesuai kondisi
		setPagingButton(self, structHeaderEdit)
...
function tbl_cellclick(self, evt) {
	...
	const structHeaderEdit = self.Modules.structHeaderEdit
	structHeaderEdit.Section.show({}, (evt)=>{
		openRow(self, tr)
	})
...
async function tbl_loadData(self, params={}) {
	console.log('loading structHeader data')
	console.log(params)
