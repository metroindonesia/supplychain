...
-- =============================================
-- ADD _timestamp
alter table core."role" add _timestamp timestamp with time zone not null default now();
comment on column core."role"._timestamp is 'data timestamp';
...
-- INDEX
-- =============================================
DROP INDEX IF EXISTS core.idx$core$role$_timestamp;
CREATE INDEX idx$core$role$_timestamp ON core.role (_timestamp);
