...
import * as Ext from './partnertype-ext.mjs'
...
const CurrentSectionId = Context.Sections.partnertypeHeaderEdit
const CurrentSection = Crsl.Items[CurrentSectionId]
const Source = Context.Source
const CurrentState = {}

const TitleWhenNew = 'New Partner Type'
const TitleWhenView = 'View Partner Type'
const TitleWhenEdit = 'Edit Partner Type'
const EditModeText = 'Edit'
const LockModeText = 'Lock'

const btn_edit = new $fgta5.ActionButton('partnertypeHeaderEdit-btn_edit')
const btn_save = new $fgta5.ActionButton('partnertypeHeaderEdit-btn_save')
const btn_new = new $fgta5.ActionButton('partnertypeHeaderEdit-btn_new', 'partnertypeHeader-new')
const btn_del = new $fgta5.ActionButton('partnertypeHeaderEdit-btn_delete')
const btn_reset = new $fgta5.ActionButton('partnertypeHeaderEdit-btn_reset')
const btn_prev = new $fgta5.ActionButton('partnertypeHeaderEdit-btn_prev')
const btn_next = new $fgta5.ActionButton('partnertypeHeaderEdit-btn_next')


const btn_recordstatus = document.getElementById('partnertypeHeader-btn_recordstatus')
const btn_logs = document.getElementById('partnertypeHeader-btn_logs')
const btn_about = document.getElementById('partnertypeHeader-btn_about')

const frm = new $fgta5.Form('partnertypeHeaderEdit-frm');
const obj_partnertype_id = frm.Inputs['partnertypeHeaderEdit-obj_partnertype_id']
const obj_partnertype_name = frm.Inputs['partnertypeHeaderEdit-obj_partnertype_name']
const obj_partnertype_isemployee = frm.Inputs['partnertypeHeaderEdit-obj_partnertype_isemployee']	
...
export async function init(self, args) {
	console.log('initializing partnertypeHeaderEdit ...')
	...
	// export async function partnertypeHeaderEdit_init(self, CurrentState)
	const fn_init_name = 'partnertypeHeaderEdit_init'
...
export async function openSelectedData(self, params) {
	...
	try {
		...
		// export async function partnertypeHeaderEdit_isEditDisabled(self, data)
		const fn_iseditdisabled_name = 'partnertypeHeaderEdit_isEditDisabled'
		...
		// export async function partnertypeHeaderEdit_formOpened(self, frm, CurrentState)
		const fn_formopened_name = 'partnertypeHeaderEdit_formOpened'
...
async function backToList(self, evt) {
	...
	if (goback) {
		frm.lock()
		const listId =  Context.Sections.partnertypeHeaderList
...
async function  frm_locked(self, evt) {
	...
	// export function partnertypeHeaderEdit_formLocked(self, frm, CurrentState) {}
	const fn_name = 'partnertypeHeaderEdit_formLocked'
...
async function  frm_unlocked(self, evt) {
	...
	// export function partnertypeHeaderEdit_formUnlocked(self, frm, CurrentState) {}
	const fn_name = 'partnertypeHeaderEdit_formUnlocked'
	const fn = Extender[fn_name]
	if (typeof fn === 'function') {
		fn(self, frm, CurrentState)
	}
...
async function btn_new_click(self, evt) {
	...
	const partnertypeHeaderList = self.Modules.partnertypeHeaderList
	const listsecid = partnertypeHeaderList.Section.Id
	...
	try {
		...
		const fn_newdata_name = 'partnertypeHeaderEdit_newData'
		const fn_newdata = Extender[fn_newdata_name]
		if (typeof fn_newdata === 'function') {
			// export async function partnertypeHeaderEdit_newData(self, datainit, frm) {}
		...
		if (fromListSection) {
			...
			self.Modules.partnertypeHeaderList.Section.show()
		}
	}
}
...
async function btn_save_click(self, evt) {
	...
	// Extender Autofill
	const fn_autofill_name = 'partnertypeHeaderEdit_autofill'
	...
	// Extender Saving
	// export async function partnertypeHeaderEdit_dataSaving(self, dataToSave, frm, args) {}
	const args = { cancelSave: false }
	const fn_datasaving_name = 'partnertypeHeaderEdit_dataSaving'
	...
	try {
		...
		// Extender Saving
		const fn_datasaved_name = 'partnertypeHeaderEdit_dataSaved'
		const fn_datasaved = Extender[fn_datasaved_name]
		if (typeof fn_datasaved === 'function') {
			// export async function partnertypeHeaderEdit_dataSaved(self, data, frm) {}
		...
		if (isNewData) {
			...
			self.Modules.partnertypeHeaderList.addNewRow(self, data)
		} else {
			console.log('update data baris yang dibuka')
			self.Modules.partnertypeHeaderList.updateCurrentRow(self, data)
		}
...
async function btn_del_click(self, evt) {
	...
	try {
		...
		self.Modules.partnertypeHeaderList.removeCurrentRow(self)
...
async function btn_prev_click(self, evt) {
	...
	self.Modules.partnertypeHeaderList.selectPreviousRow(self)
}

async function btn_next_click(self, evt) {
	console.log('btn_next_click')
	self.Modules.partnertypeHeaderList.selectNextRow(self)
}
...
async function btn_recordstatus_click(self, evt) {
	...
	pageHelper.openSection(self, 'fRecord-section', params, async ()=>{
		...
		try {
			...
			const fn_addrecordinfo_name = 'partnertypeHeaderEdit_addRecordInfo'
...
async function btn_about_click(self, evt) {
	...
	pageHelper.openSection(self, 'fAbout-section', params, async ()=>{
		...
		AboutSection.Title = 'About Partner Type'
