...
import * as partnertypeHeaderList from './partnertypeHeaderList.mjs' 
import * as partnertypeHeaderEdit from './partnertypeHeaderEdit.mjs' 
import * as Extender from './partnertype-ext.mjs'
...
export default class extends Module {
	...
	async main(args={}) {
		...
		self.Modules = { 
			partnertypeHeaderList, 
			partnertypeHeaderEdit, 
		}
		...
		try {
			...
			await Promise.all([ 
				partnertypeHeaderList.init(self, args), 
				partnertypeHeaderEdit.init(self, args), 
			...
			const modNameList = ['partnertypeHeaderEdit']
...
async function render(self) {
	try {
		...
		// Setup Icon
		Crsl.setIconUrl('public/modules/partnertype/partnertype.svg')
		...
		// partnertype-ext.mjs, export function extendPage(self) {} 
