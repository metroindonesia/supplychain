...
const CurrentSectionId = Context.Sections.currHeaderList
const CurrentSection = Crsl.Items[CurrentSectionId]
const CurrentState = {}

const tbl =  new $fgta5.Gridview('currHeaderList-tbl')
const pnl_search = document.getElementById('currHeaderList-pnl_search')
const btn_gridload = new $fgta5.ActionButton('currHeaderList-btn_gridload') 

export const Section = CurrentSection
export const SearchParams = {}

export async function init(self, args) {
	console.log('initializing currHeaderList ...')
	...
	try {
		...
		const obj_searchtext = document.getElementById('currHeaderList-txt_searchtext')
		const btn_load = document.getElementById('currHeaderList-btn_gridload')
		...
		// currHeaderList-ext.mjs, export function initSearchParams(self, SearchParams) {} 
...
async function openRow(self, tr) {
	...
	const currHeaderEdit = self.Modules.currHeaderEdit
	currHeaderEdit.clearForm(self, 'loading...')

	try {
		setCurrentRow(self, tr)
		CurrentState.SelectedRow.keyValue = keyvalue
		CurrentState.SelectedRow.key = key
		await currHeaderEdit.openSelectedData(self, {key:key, keyvalue:keyvalue})

		// matikan atau nyalakan button prev/next sesuai kondisi
		setPagingButton(self, currHeaderEdit)
...
function tbl_cellclick(self, evt) {
	...
	const currHeaderEdit = self.Modules.currHeaderEdit
	currHeaderEdit.Section.show({}, (evt)=>{
		openRow(self, tr)
	})
...
async function tbl_loadData(self, params={}) {
	console.log('loading currHeader data')
	console.log(params)
