...
import * as structhrkHeaderList from './structhrkHeaderList.mjs' 
import * as structhrkHeaderEdit from './structhrkHeaderEdit.mjs' 
import * as Extender from './structhrk-ext.mjs'
...
export default class extends Module {
	...
	async main(args={}) {
		...
		app.setTitle('Structure Hierarchy')
		app.showFooter(true)
		...
		try {
			...
			await Promise.all([ 
				structhrkHeaderList.init(self, args), 
				structhrkHeaderEdit.init(self, args), 
			...
			const modNameList = ['structhrkHeaderEdit']
...
async function render(self) {
	try {
		...
		// Setup Icon
		Crsl.setIconUrl('public/modules/structhrk/structhrk.svg')
		...
		// structhrk-ext.mjs, export function extendPage(self) {} 
