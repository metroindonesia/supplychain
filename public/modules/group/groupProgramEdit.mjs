...
async function btn_del_click(self, evt) {
	...
	try {
		...
		// Extender Deleting
		// export async function groupProgramEdit_dataDeleting(self, id, args) {}
		const args = { cancelDelete: false }
		const fn_datadeleting_name = 'groupProgramEdit_dataDeleting'
		...
		// Extender Delete
		// export async function groupProgramEdit_dataDeleted(self, data) {}
		const fn_datadeleted_name = 'groupProgramEdit_dataDeleted'
