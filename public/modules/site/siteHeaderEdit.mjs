...
const CurrentSectionId = Context.Sections.siteHeaderEdit
const CurrentSection = Crsl.Items[CurrentSectionId]
const Source = Context.Source
const CurrentState = {}

const TitleWhenNew = 'New Site'
const TitleWhenView = 'View Site'
const TitleWhenEdit = 'Edit Site'
const EditModeText = 'Edit'
const LockModeText = 'Lock'

const btn_edit = new $fgta5.ActionButton('siteHeaderEdit-btn_edit')
const btn_save = new $fgta5.ActionButton('siteHeaderEdit-btn_save')
const btn_new = new $fgta5.ActionButton('siteHeaderEdit-btn_new', 'siteHeader-new')
const btn_del = new $fgta5.ActionButton('siteHeaderEdit-btn_delete')
const btn_reset = new $fgta5.ActionButton('siteHeaderEdit-btn_reset')
const btn_prev = new $fgta5.ActionButton('siteHeaderEdit-btn_prev')
const btn_next = new $fgta5.ActionButton('siteHeaderEdit-btn_next')


const btn_recordstatus = document.getElementById('siteHeader-btn_recordstatus')
const btn_logs = document.getElementById('siteHeader-btn_logs')
const btn_about = document.getElementById('siteHeader-btn_about')
...
const obj_site_location = frm.Inputs['siteHeaderEdit-obj_site_location']
...
export async function init(self, args) {
	console.log('initializing siteHeaderEdit ...')
	...
	// export async function siteHeaderEdit_init(self, CurrentState)
	const fn_init_name = 'siteHeaderEdit_init'
...
export async function openSelectedData(self, params) {
	...
	try {
		...
		// export async function siteHeaderEdit_isEditDisabled(self, data)
		const fn_iseditdisabled_name = 'siteHeaderEdit_isEditDisabled'
		...
		// export async function siteHeaderEdit_formOpened(self, frm, CurrentState)
		const fn_formopened_name = 'siteHeaderEdit_formOpened'
...
async function backToList(self, evt) {
	...
	if (goback) {
		frm.lock()
		const listId =  Context.Sections.siteHeaderList
...
async function  frm_locked(self, evt) {
	...
	// export function siteHeaderEdit_formLocked(self, frm, CurrentState) {}
	const fn_name = 'siteHeaderEdit_formLocked'
...
async function  frm_unlocked(self, evt) {
	...
	// export function siteHeaderEdit_formUnlocked(self, frm, CurrentState) {}
	const fn_name = 'siteHeaderEdit_formUnlocked'
	const fn = Extender[fn_name]
	if (typeof fn === 'function') {
		fn(self, frm, CurrentState)
	}
...
async function btn_new_click(self, evt) {
	...
	const siteHeaderList = self.Modules.siteHeaderList
	const listsecid = siteHeaderList.Section.Id
	...
	try {
		...
		const fn_newdata_name = 'siteHeaderEdit_newData'
		...
		if (fromListSection) {
			...
			self.Modules.siteHeaderList.Section.show()
		}
	}
}
...
async function btn_save_click(self, evt) {
	...
	// Extender Autofill
	const fn_autofill_name = 'siteHeaderEdit_autofill'
	...
	// Extender Saving
	// export async function siteHeaderEdit_dataSaving(self, dataToSave, frm, args) {}
	const args = { cancelSave: false }
	const fn_datasaving_name = 'siteHeaderEdit_dataSaving'
	...
	try {
		...
		// Extender Saving
		const fn_datasaved_name = 'siteHeaderEdit_dataSaved'
		...
		if (isNewData) {
			...
			self.Modules.siteHeaderList.addNewRow(self, data)
		} else {
			console.log('update data baris yang dibuka')
			self.Modules.siteHeaderList.updateCurrentRow(self, data)
		}
...
async function btn_del_click(self, evt) {
	...
	try {
		...
		self.Modules.siteHeaderList.removeCurrentRow(self)
...
async function btn_prev_click(self, evt) {
	...
	self.Modules.siteHeaderList.selectPreviousRow(self)
}

async function btn_next_click(self, evt) {
	console.log('btn_next_click')
	self.Modules.siteHeaderList.selectNextRow(self)
}
