...
import * as permissionHeaderList from './permissionHeaderList.mjs' 
import * as permissionHeaderEdit from './permissionHeaderEdit.mjs' 
import * as Extender from './permission-ext.mjs'
...
export default class extends Module {
	...
	async main(args={}) {
		...
		try {
			...
			await Promise.all([ 
				permissionHeaderList.init(self, args), 
				permissionHeaderEdit.init(self, args), 
			...
			const modNameList = ['permissionHeaderEdit']
...
async function render(self) {
	try {
		...
		// Setup Icon
		Crsl.setIconUrl('public/modules/permission/permission.svg')
		...
		// permission-ext.mjs, export function extendPage(self) {} 
