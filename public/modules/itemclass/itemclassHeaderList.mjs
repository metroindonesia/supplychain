...
const CurrentSectionId = Context.Sections.itemclassHeaderList
const CurrentSection = Crsl.Items[CurrentSectionId]
const CurrentState = {}

const tbl =  new $fgta5.Gridview('itemclassHeaderList-tbl')
const pnl_search = document.getElementById('itemclassHeaderList-pnl_search')
const btn_gridload = new $fgta5.ActionButton('itemclassHeaderList-btn_gridload') 

export const Section = CurrentSection
export const SearchParams = {}

export async function init(self, args) {
	console.log('initializing itemclassHeaderList ...')
	...
	try {
		...
		const obj_searchtext = document.getElementById('itemclassHeaderList-txt_searchtext')
		const btn_load = document.getElementById('itemclassHeaderList-btn_gridload')
		...
		// itemclassHeaderList-ext.mjs, export function initSearchParams(self, SearchParams) {} 
...
export function keyboardAction(self, actionName, evt) {
	if (actionName=='up') {
		...
		if (tbl.CurrentRow!=null) {
			itemclassHeaderEdit.Section.show({}, ()=>{
...
async function openRow(self, tr) {
	...
	const itemclassHeaderEdit = self.Modules.itemclassHeaderEdit
	itemclassHeaderEdit.clearForm(self, 'loading...')

	try {
		setCurrentRow(self, tr)
		CurrentState.SelectedRow.keyValue = keyvalue
		CurrentState.SelectedRow.key = key
		await itemclassHeaderEdit.openSelectedData(self, {key:key, keyvalue:keyvalue})

		// matikan atau nyalakan button prev/next sesuai kondisi
		setPagingButton(self, itemclassHeaderEdit)
...
function tbl_cellclick(self, evt) {
	...
	const itemclassHeaderEdit = self.Modules.itemclassHeaderEdit
	itemclassHeaderEdit.Section.show({}, (evt)=>{
		openRow(self, tr)
	})
...
async function tbl_loadData(self, params={}) {
	console.log('loading itemclassHeader data')
	console.log(params)
