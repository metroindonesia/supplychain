...
import * as regitemHeaderList from './regitemHeaderList.mjs' 
import * as regitemHeaderEdit from './regitemHeaderEdit.mjs' 
import * as Extender from './regitem-ext.mjs'
...
export default class extends Module {
	...
	async main(args={}) {
		...
		try {
			...
			await Promise.all([ 
				regitemHeaderList.init(self, args), 
				regitemHeaderEdit.init(self, args), 
			...
			const modNameList = ['regitemHeaderEdit']
...
async function render(self) {
	try {
		...
		// regitem-ext.mjs, export function extendPage(self) {} 
