...
async function brand_headerList(self, body) {
	...
	try {
		...
		for (var row of rows) {
			...
			// lookup: struct_name dari field struct_name pada table public.struct dimana (public.struct.struct_id = public.brand.struct_id)
			{
...
async function brand_headerCreate(self, body) {
	...
	try {
		...
		const result = await db.tx(async tx=>{
			...
			const cmd = sqlUtil.createInsertCommand(tablename, data, ['brand_id'])
