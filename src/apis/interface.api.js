...
export default class extends Api {
	...
	// extender call
	async execute(body) { return await interface_execute(this, body) }
...
async function interface_execute(self, body) {
	const { fnName } = body
	...
	if (typeof Extender[fnName] === 'function') {
		// export async function [fnName](self, db, body, interface_log) {}
		return await Extender[fnName](self, db, body, interface_log)
	} else {
