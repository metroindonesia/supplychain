...
export default class extends Api {
	...
	// extender call
	async execute(body) { return await programgroup_execute(this, body) }
...
async function programgroup_execute(self, body) {
	const { fnName } = body
	...
	if (typeof Extender[fnName] === 'function') {
		// export async function [fnName](self, db, body, programgroup_log) {}
		return await Extender[fnName](self, db, body, programgroup_log)
	} else {
